...
export const extraReactQuestions: QuestionSeed[] = [
  ...
  },
  {
    ...
    type: 'mcq',
    prompt: 'What is the primary purpose of `useMemo` in React?',
  ...
  },
  {
    ...
    type: 'mcq',
    prompt: 'Why would you use `useCallback` when passing callbacks to memoized children?',
...
export const extraTypescriptQuestions: QuestionSeed[] = [
  {
    ...
    subtopic: 'keyof',
    type: 'mcq',
    prompt: 'What does the `keyof` operator produce for a type `T`?',
  ...
  },
  {
    ...
    subtopic: 'Partial',
    type: 'mcq',
    prompt: 'What does `Partial<T>` do to a type T?',
  ...
  },
  {
    ...
    subtopic: 'infer',
    type: 'mcq',
    prompt: 'In conditional types, what does the `infer` keyword allow you to do?',
