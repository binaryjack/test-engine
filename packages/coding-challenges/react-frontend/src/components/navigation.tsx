...
export function Navigation() {
  const { isExamMode } = useSelector((state: RootState) => state.challenge);
      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link 
          ...
          className={clsx(
            ...
            isExamMode ? "pointer-events-none opacity-20" : "hover:text-blue-400"
          )}
        >
        ...
        <div className={clsx(
          ...
          isExamMode && "pointer-events-none opacity-20"
        )}>
